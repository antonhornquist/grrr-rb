...
puts "warning: monome will probably not work correctly unless you use jruby" unless using_jruby?


=begin

	MonomeSerial settings, generally speaking:

		I/O Protocol: OpenSound Control
		Host Address: monome_instance.host_address
		Host Port: monome_instance.host_port
		Listen Port: monome_instance.listen_port
		Prefix: monome_instance.prefix
...
class Monome64 < Grrr::Controller
	...
	def initialize(prefix=nil, host_address=nil, host_port=nil, listen_port=nil, view=nil, origin=nil, create_top_view_if_none_is_supplied=true)
		...
		@server = OSC::EMServer.new(@host_port)
